...
SAP BW/4 Hana is often used by larger enterprises as an analytical Data Warehouse. The BW application has matured since 1998. It comes with its own vocabulary, learning ressources and legions of experts. 
...
I got the feeling that I only touched the surface. Obviously there is still a lot to explore, especially more advanced topics like partioning, warm/ cold storage, delta loads etc, enough for another blog post.
